...
- (void)scene:(UIScene *)scene willConnectToSession:(UISceneSession *)session options:(UISceneConnectionOptions *)connectionOptions {
    ...
    if (scene != nil) {
        ...
        SBSearchViewController *searchViewController = storyboard.instantiateInitialViewController;
        SBNavigationViewController *navigationController = [[SBNavigationViewController alloc] initWithRootViewController:searchViewController];
